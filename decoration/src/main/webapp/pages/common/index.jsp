...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <!-- Main row -->
            <div class="row">
                <c:forEach var="examples" items="${examplesList}" varStatus="status">
                    <div class="col-md-3">
                        <!-- Default box -->
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title"  >${examples.title}</h3>
                            ...
                            <div class="box-body" style="display: block;">
                               <a href="<c:url value="/render/todetail" />?id=${status.index + 1501}">
                                   <img src="/images/pic${examples.pic}" >
                               </a>
                            </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                            <p class="text-muted well well-sm no-shadow">
                                <span class="pull-right">更新时间：${examples.updated}</span>
                            </p>
                        </div>
                        </div>
                    </div>
